...
- Use search for terms (softmax, PCA, AUC, leakage).  
- Math renders with MathJax.  
- Figures enlarge in a new tab if needed.  
- Report errors via GitHub Issues on this repo.

## Safety reminder

This site never replaces institutional ML governance, IRB review, or clinical protocols.
Synthetic vignettes are teaching devices—not real patients.
