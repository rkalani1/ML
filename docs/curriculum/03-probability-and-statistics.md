...
![Central limit theorem: sampling means of Exponential(1) for n=5 vs n=40.](../assets/figures/ml_fig_clt_sampling.png)
...
![Bernoulli log-likelihood surface with MLE at k/n.](../assets/figures/ml_fig_mle_bernoulli.png)

*For k=7 successes in n=10 trials, ℓ(p)=7 log p + 3 log(1−p) peaks at p̂=0.7.*
